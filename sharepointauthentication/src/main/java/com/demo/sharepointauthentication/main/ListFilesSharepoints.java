...
public class ListFilesSharepoints {
	...
	public static void main(String[] args) throws Exception{
	     ...
	     String user = "amitdhakal";

	     String pwd = "Eddie456?dhakal456";
	     ...
	     try {
	       ...
	       HttpEntity entity = (HttpEntity) response2.getEntity();
	       ...
	       if (rc == HttpStatus.SC_OK) {
	          ...
	          FileUtils.writeByteArrayToFile(ff, EntityUtils.toByteArray((org.apache.http.HttpEntity) entity));
